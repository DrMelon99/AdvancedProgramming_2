...
---
## 팀원
박제혁: [무궁화 꽃이 피었습니다], [야간게임], [전체 프로젝트 관리]
...
✅ 아이템 및 플레이어의 상호작용 결과를 하단 상태창에 표시 (2초 동안)
    ...
    - n번 플레이어가 m번 플레이어에게서 아이템 뺏거나 교환을 성공 했을 시
```
6. 줄다리기
```
✅ 맵 관련
...
✅ n번째 플레이어가 제비를 골랐다면 <통과 / 탈락> 결과를 다이얼로그를 통해 출력
    - 통과일 경우: 선택된 제비를 '?'에서 '@'로 바꾸고 나머지 제비로 해당 라운드 계속 진행
    - 탈락일 경우: 살아남은 플레이어 수 만큼 나머지 제비를 섞은 후 다음 라운드 진행
